...
Forzamiento Satelital ($z=0$) & \textit{Pendiente} & Anclaje de biomasa superficial mediante MODIS / Ocean Color como condición de frontera blanda a profundidad $z=0$. \\ \hline
Producción Biológica & \textit{Pendiente} & Término fotosintético $+ P_0 e^{-z / z_{photic}} C$ en la zona fótica en lugar del decaimiento pasivo simple $-R \cdot C$. \\ \hline
